...
func init() {
	...
	utilruntime.Must(streamingaudiov1alpha1.AddToScheme(scheme))
...
func main() {
	...
	if err = (&controller.VoiceModelReconciler{
		Client: mgr.GetClient(),
		Scheme: mgr.GetScheme(),
	}).SetupWithManager(mgr); err != nil {
		setupLog.Error(err, "unable to create controller", "controller", "VoiceModel")
		os.Exit(1)
	}
